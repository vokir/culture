<template>
  <div class="search" ref="searchFilterContainer">
    ...
    <div class="search-filter-container" @click="togglePopup" >
      <v-dropdown class="search-filter" @focusout="popupOff" :delay="{show: 0,hide: 140}" :triggers="[]" :popperTriggers="[]" :shown="isOpened"  :autoHide="false" :container="searchFilterContainer">
        <template #popper>
