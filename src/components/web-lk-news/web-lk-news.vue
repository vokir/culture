<template>
  <div class="preview">
    ...
    <div class="preview__date">
      ...
      <template v-else> 20 ноября 2021 в 15:18</template>
      <svg
        fill="none"
        height="15"
        viewBox="0 0 15 15"
    ...
    <div v-if="complex && complex.UF_NAME" class="preview__tags">
      <v-badge :text="complex.UF_NAME" variant="gray" />
    </div>
    <div class="preview__desc">
      ...
      <template v-else>
        9 ноября проведен подсчет голосов в рамках двух внеочередных общих собраний собственников
        помещений в форме очно заочного голосования.
      </template>
    </div>
    <div v-if="!detail" class="preview__show-all">Новость полностью</div>
  </div>
</template>
