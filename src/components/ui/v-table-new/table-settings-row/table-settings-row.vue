<template>
  <VDropdown :distance="10" :skidding="-10" placement="right-start" popper-class="settings-popup">
    <div class="settings-button">
      <v-icon height="16px" name="burger" width="16px" />
    </div>
    <template #popper>
      <div class="settings">
...
<style lang="scss" scoped src="./table-settings-row.scss"></style>
