<template>
  <div class="image-placeholder">
    <div v-if="image && !image.src" class="image-placeholder__placeholder" @click="$emit('openModal')">
      <div class="image-placeholder__icon">
        <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke="#C6CDD3" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
          />
          <path
