    ...
    <div class="search-filter-container">
      ...
      >
        ...
        <input
          ...
          type="text"
          :placeholder="filterPlaceholder + ' + ' + searchPlaceholderProp"
          @click="popupListener"
        >
      </v-dropdown>
    </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const filterPlaceholderRef = ref('')

    const filterPlaceholder = computed(() => {
      if (props.modelValue.length) {
        filterPlaceholderRef.value = ''
      }
      else {
        filterPlaceholderRef.value = props.filterPlaceholderProp
      }
      return filterPlaceholderRef.value
    })
