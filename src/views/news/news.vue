  ...
  <div class="container-content">
    <div class="container-header">
      ...
      <div class="container-header__search">
        <v-filter-and-search v-model="filter" @setFilter="setFilter" @filterTable="filterTable" @setSearch="setSearch" :filterList="store.newsTypes" @clearFilter="clearFilter" :placeholder="'Фильтр + поиск'" :variant="'transparent'"></v-filter-and-search>
      </div>
